...
HD inline u64 morton3D(u32 x, u32 y, u32 z){
...
HD inline u32 clampu32(u64 v){ return (v>0xffffffffULL)? 0xffffffffu : (u32)v; }

// Maak morton sleutel met regio-prefix (R MSB’s)
HD inline u64 morton_met_regio(u32 xi,u32 yi,u32 zi, u32 regioCode){
...
HD inline void kwantiseer_punt(const Vec3f&p, const Kwantisatie&Q, u32 &xi,u32 &yi,u32 &zi){
