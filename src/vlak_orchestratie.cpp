...
// d_planaireRegressie zit als __device__ helper; maak evt. wrapper-kernel als je die device-weg wil houden
                              ...
                              std::vector<PlaneHyp>& uit)
{
    ...
    {
        // 2b) planaire regressie (device helper via wrapper-kernel of inline in aparte kernel)
